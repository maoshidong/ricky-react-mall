...
import SavedBoms from '~/components/partials/account/modules/SavedBoms';

import { changeServerSideLanguage, redirectLogin } from '~/utilities/easy-helpers'; 
import useLanguage from '~/hooks/useLanguage';

const SavedBomsPage = ({paramMap}) => {
    const { i18Translate } = useLanguage();
    const i18Title = i18Translate('i18Seo.savedBoms.title', "")
    const i18Key = i18Translate('i18Seo.savedBoms.keywords', "")
    const i18Des = i18Translate('i18Seo.savedBoms.description', "")
    return (
