...
const CustomerReference = ({ paramMap }) => {
	const { i18Translate } = useLanguage();
	const i18Title = i18Translate('i18Seo.customerReference.title', '');
	const i18Key = i18Translate('i18Seo.customerReference.keywords', '');
	const i18Des = i18Translate('i18Seo.customerReference.description', '');
	...
	return (
		<PageContainer paramMap={paramMap}>
			...
			<AccountLeft>
				<FavoritesList curActive="customer-reference1" />
			</AccountLeft>
		</PageContainer>
	);
};
