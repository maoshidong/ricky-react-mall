...
const BrowseHistoryPage = ({paramMap}) => {
    const { i18Translate } = useLanguage();

    const i18Title = i18Translate('i18Seo.browseHistory.title', "")
    const i18Key = i18Translate('i18Seo.browseHistory.keywords', "")
    const i18Des = i18Translate('i18Seo.browseHistory.description', "")
    return (
        <PageContainer paramMap={paramMap}>
            ...
            <AccountLeft>
                <FavoritesList curActive="browse-history" />
            </AccountLeft>
        </PageContainer>
    );
};
